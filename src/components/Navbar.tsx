...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="h-16 bg-slate-900 border-b border-slate-800 px-4 md:px-6 flex items-center justify-between sticky top-0 z-30 shadow-md">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <span className="font-bold text-lg text-white tracking-tight">VS Advisory</span>
            ...
            <p className="text-xs text-slate-400 hidden sm:block">Live Google Sheets Portal</p>
          </div>
        </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <button
          ...
          className="flex items-center space-x-1.5 bg-brand-600 hover:bg-brand-500 text-white px-3.5 py-2 rounded-xl text-sm font-semibold shadow-md shadow-brand-600/30 transition-all active:scale-95"
        >
        ...
        <button
          ...
          className="p-2 rounded-xl bg-slate-800 border border-slate-700 text-slate-300 hover:text-white hover:bg-slate-700/80 transition-all disabled:opacity-50"
        >
        ...
        <div className="relative pl-2 border-l border-slate-800">
          ...
          >
            {photo ? (
              <img src={photo} alt={displayName} className="w-7 h-7 rounded-full object-cover ring-1 ring-brand-500" />
            ) : (
              <div className="w-7 h-7 rounded-full bg-brand-600/30 border border-brand-500/40 text-brand-300 flex items-center justify-center font-bold text-xs">
                {displayName.charAt(0).toUpperCase()}
              </div>
            )}
            <div className="hidden sm:block text-left">
              <p className="text-xs font-semibold text-slate-200 truncate max-w-[100px]">{displayName}</p>
            </div>
